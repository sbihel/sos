...
\end{tabular}
\end{center}
\todo{define those functions for the new (and old?) commands.}
...
\begin{itemize}
 \item \(R\!D_\text{in}(l)\), the allocated arrays that enter in \(l\)
 \item \(R\!D_\text{in}(l)\), the allocated arrays that exit from \(l\)
\end{itemize}
